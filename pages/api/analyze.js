...
function buildSystem(jurisdictionKey) {
  return [
    ...
    "DO NOT output ANY content for this section.",
    "The entire Development Opportunity section is rendered deterministically from parcel data in the UI.",
    "This includes density math, buildable area, max floor area, TOC bonus, max buildout, existing structure, AND state housing law eligibility.",
    "Just output the '## Development Opportunity' header and nothing else — leave the section body completely empty.",
    "",
    ...
    "",
    "### Timeline",
    "Weeks [N]-[N]: [activity — use full descriptive name, max 35 chars, e.g. 'Geotechnical investigation' not 'Geotechnical inv']",
