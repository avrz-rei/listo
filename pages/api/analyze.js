...
function buildSystem(jurisdictionKey) {
  return [
    ...
    "═══════════════════════════════════════════════════════════════════════════",
    "",
    "STATE HOUSING LAW ELIGIBILITY RULES (add to Development Opportunity section):",
    "",
    "SB 79 — TRANSIT-ORIENTED DEVELOPMENT UPZONING (effective July 1, 2026):",
    "  Signed Oct 10, 2025. Government Code §§65912.155–65912.162.",
    "  Applies in LA County (urban transit county with 15+ rail stations).",
    "  ELIGIBILITY CRITERIA (check each):",
    "    1. Site within ½ mile of a qualifying TOD stop (Tier 1 or Tier 2)",
    "       - PROXY: If parcel has AB 2097 = YES or ZI-2452 (Transit Priority Area), LIKELY ELIGIBLE",
    "    2. Site zoned residential, mixed-use, or commercial",
    "    3. Site does NOT have >2 RSO units occupied in past 7 years",
    "    4. Site NOT in Very High Fire Hazard Severity Zone (exception: until end of current housing cycle)",
    "    5. Not a recent eminent domain acquisition (post-July 1, 2025)",
    "  DEVELOPMENT STANDARDS (state overrides local zoning):",
    "    Tier 1 stops (heavy rail / high-frequency commuter rail):",
    "      Within ¼ mile: Up to 95 ft height, 160 units/acre, FAR 5.25",
    "      ¼ to ½ mile: Up to 75 ft height, 100 units/acre, FAR 4.25",
    "    Tier 2 stops (light rail / BRT / high-frequency commuter rail):",
    "      Within ¼ mile: Up to 55 ft height, 60 units/acre, FAR 2.75",
    "      ¼ to ½ mile: Up to 55 ft height, 30 units/acre, FAR 1.0",
    "  REQUIREMENTS FOR SB 79 PROJECTS:",
    "    - Projects >10 units: 7% ELI, 10% VLI, or 13% LI affordable units",
    "    - Average unit size ≤1,750 sf net habitable",
    "    - Affordability covenants: 55 years rental, 45 years ownership",
    "    - Buildings >85 ft: prevailing wage / skilled & trained workers required",
    "  IMPORTANT: SB 79 is NOT YET EFFECTIVE — takes effect July 1, 2026.",
    "  Flag as: 'SB 79 ELIGIBLE (effective July 2026) — state may override local height/density limits'",
    "  Include the applicable tier standards in the report.",
    "  NOTE: LA City Council adopted 'Approach C' (Delayed Effectuation) in Dec 2025.",
    "  SCAG official maps pending. Use AB 2097 + ZI-2452 as eligibility proxy.",
    "",
    "SB 684 — STARTER HOME REVITALIZATION ACT (effective Jan 1, 2024):",
    "  Government Code §66499.2 et seq.",
    "  Provides ministerial approval (no CEQA, no hearing, 60-day decision) for:",
    "    - ≤10 units on ≤10 parcels",
    "    - Multifamily-zoned lot ≤5 acres",
    "    - Substantially surrounded by qualified urban uses",
    "    - Average unit size ≤1,750 sf net habitable",
    "  ELIGIBILITY CHECK: If zoning is R2/R3/R4/R5 (multifamily) AND lot ≤5 acres → LIKELY ELIGIBLE",
    "  Flag as: 'SB 684 ELIGIBLE — ministerial approval, 60-day decision, no CEQA'",
    "",
    "SB 1123 — STARTER HOME ACT EXPANSION (effective July 1, 2025):",
    "  Extends SB 684 to VACANT single-family zoned lots:",
    "    - ≤10 units on vacant lot ≤1.5 acres",
    "    - Single-family zone (R1, RS, RE, etc.)",
    "    - Lot must be vacant (no permanent habitable structure)",
    "    - ADUs/JADUs may be additional (not counted toward 10-unit max)",
    "  ELIGIBILITY CHECK: If zoning is R1/RS/RE AND lot ≤1.5 acres AND appears vacant → FLAG",
    "  Note: 'Vacant' = no permanent structure, not occupied in past 5 years",
    "",
    "AB 2097 — PARKING REDUCTION (effective Jan 1, 2023):",
    "  If AB 2097 = YES (within ½ mile of major transit stop):",
    "  City CANNOT impose minimum parking requirements for new residential/commercial.",
    "  Flag as: 'AB 2097 — no minimum parking required (within ½ mile of major transit stop)'",
    "",
    "INSTRUCTIONS FOR STATE LAW SECTION:",
    "  - Only flag laws where the parcel data suggests eligibility",
    "  - Always include the effective date and Government Code citation",
    ...
    "If VERIFIED, show the value. If NOT VERIFIED, state 'NOT VERIFIED — check zimas.lacity.org'.",
    "",
    "## Project Overview",
    ...
    "For each eligible law, state:",
    "  [LAW] | [ELIGIBLE/LIKELY ELIGIBLE/NOT ELIGIBLE] | [one-line impact]",
    "  [Key benefit — e.g. 'Overrides R2 height limit from 45 ft to 55 ft' or 'Ministerial approval, 60-day decision']",
    "  [Requirements — affordability, unit size, labor standards]",
    "  [Effective date and Government Code citation]",
    "  'Eligibility is preliminary — verify with planning consultant'",
    "If AB 2097 = YES, always include the parking reduction note.",
    "If no state laws appear to apply, omit this subsection.",
    "",
    "## Regulations",
    "",
    "### Planning & Zoning Overlays",
    "General Plan Land Use: [value] | [VERIFIED or NOT VERIFIED]",
    "TOC (Transit Oriented Communities): [tier or N/A] | [VERIFIED or NOT VERIFIED]",
    "Specific Plans: [list] | [VERIFIED or NOT VERIFIED]",
    "HPOZ (Historic Preservation Overlay Zone): [YES/NO] | [VERIFIED or NOT VERIFIED]",
    "CDO (Community Design Overlay): [YES/NO] | [VERIFIED or NOT VERIFIED]",
    "Coastal Zone: [type or NO] | [VERIFIED or NOT VERIFIED]",
    "Community Plan: [name] | [VERIFIED or NOT VERIFIED]",
    "",
    ...
    "",
    "## Hazards & Environmental",
    "Present each hazard on its own line:",
    "Hillside Area | [YES/NO] | [VERIFIED or NOT VERIFIED]",
    "Special Grading Area | [YES/NO] | [VERIFIED or NOT VERIFIED]",
    "Very High Fire Hazard Severity Zone | [YES/NO] | [VERIFIED or NOT VERIFIED]",
    "Alquist-Priolo Fault Zone | [YES/NO] | [VERIFIED or NOT VERIFIED]",
    "Preliminary Fault Rupture Study Area | [YES/NO] | [VERIFIED or NOT VERIFIED]",
    "Liquefaction | [YES/NO] | [VERIFIED or NOT VERIFIED]",
    "Landslide | [YES/NO] | [VERIFIED or NOT VERIFIED]",
    "Tsunami Hazard | [YES/NO] | [VERIFIED or NOT VERIFIED]",
    "Sea Level Rise | [YES/NO] | [VERIFIED or NOT VERIFIED]",
    "Flood Zone | [value] | [VERIFIED or NOT VERIFIED]",
    "Methane Hazard | [value or None] | [VERIFIED or NOT VERIFIED]",
    "Airport Hazard | [value or None] | [VERIFIED or NOT VERIFIED]",
    "Nearest Fault | [name] ([distance] km) | [VERIFIED or NOT VERIFIED]",
    "",
    "## Housing",
    "RSO (Rent Stabilization Ordinance) | [YES/NO] | [VERIFIED or NOT VERIFIED]",
    "HE Replacement Required | [YES/NO] | [VERIFIED or NOT VERIFIED]",
    "Just Cause Eviction (JCO) | [YES/NO] | [VERIFIED or NOT VERIFIED]",
    "",
    "## Zone Alerts",
